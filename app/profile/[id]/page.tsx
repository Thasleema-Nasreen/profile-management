...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-black overflow-x-hidden">
      ...
      {/* TOP WHITE HEADER */}
      <div className="w-full bg-white flex items-center justify-between px-6 py-4 shadow-sm">
        <Image src="/logo-left.png" width={110} height={50} alt="Left Logo" />
        <Image src="/logo-right.png" width={110} height={50} alt="Right Logo" />
      </div>

      {/* ORANGE HERO */}
      <div className="relative w-full bg-gradient-to-r from-orange-400 to-red-500 h-[260px] flex items-center justify-between px-10">
        ...
        <div className="absolute left-1/2 -bottom-20 -translate-x-1/2">
          <div className="w-44 h-44 rounded-full border-[6px] border-white shadow-xl overflow-hidden bg-white">
            <Image
              src="/profile.jpg"
              alt="Profile"
              width={200}
      ...
      {/* ⭐ TOP-LEFT BACK BUTTON BELOW ORANGE HERO ⭐ */}
      <div className="w-full flex justify-start px-6 mt-6">
        <button
          onClick={() => router.back()}
      ...
      <div className="text-center mt-6">
        <h1 className="text-3xl font-semibold">Saksham Arora</h1>
        <p className="text-gray-600 mt-1">Male | 25 | He/Him</p>
      ...
      <div className="flex justify-center mt-10">
        <div className="bg-white border shadow-sm px-6 py-3 rounded-full flex gap-10 text-xs md:text-sm text-gray-700">
      ...
      {/* ABOUT */}
      <div className="max-w-4xl mx-auto text-center mt-12 text-gray-700 leading-relaxed px-6">
        <p>
      ...
      {/* SKILLS ICON GRID */}
      <div className="grid grid-cols-4 md:grid-cols-8 gap-8 max-w-5xl mx-auto mt-12 opacity-60 px-6">
        {[
          ...
          <div key={i} className="flex flex-col items-center">
            <Image src={s.icon} width={40} height={40} alt={s.title} />
      ...
      <div className="max-w-6xl mx-auto mt-20 px-6">
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-semibold">Case Insights & Key Projects</h2>
      ...
      <div className="max-w-5xl mx-auto mt-24 px-6">
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-lg">
          <Image src="/video-preview.jpg" width={1200} height={700} alt="Video" />
        </div>
      </div>
